...
export default function YharnamPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="aspect-video w-full bg-soft-gray border border-editorial-border mb-12 overflow-hidden rounded-xl shadow-sm">
          <iframe 
            ...
            src="https://www.youtube.com/embed/OTDUGyiyBHE" 
            title="야남 시가지 영상"
        ...
        <div className="flex justify-center mb-24">
          <a 
            href="https://drive.google.com/file/d/1tlXW5O89lcFbVqQbf1-rEPh-805JBtme/view?usp=drive_link" 
            target="_blank" 
